...
<body>
    <div class="row">
        ...
        <div class="col-xs-7" style="padding-top: 0px; left: 100px;">
            ...
            <a href="#" class="btn" data-toggle="modal" data-target="#exampleModalLong">Contact</a>
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <center>
                                ...
                                <a href="products3.php?name=<?php echo $row['name']; ?>&price=<?php echo $row['price']; ?>"><button class="fom-control btn btn-primary">Add to Cart</button></a>
                            </center>
                        </div>
                    </div>
                </div>
