...
$query="Select id,name,price,image from books";
$result=mysqli_query($con,$query) or die(mysqli_error($con));
$querya="Select id,name,price,image from books_ch";
$resulta=mysqli_query($con,$querya) or die(mysqli_error($con));
$queryb="Select id,name,price,image from books_mt";
...
<body>
    <div class="row">
        ...
        <div class="col-xs-7" style="padding-top: 0px; left: 100px;">
            ...
            <a href="#" class="btn" data-toggle="modal" data-target="#cat">Categories</a>
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <center>
                                <a href="products.php" style="text-decoration:none; color:black; font-size:20px;"><button style="background-color:transparent; outline:none; border:0px;padding:10px; border-bottom:1px solid black;">Show All</button></a><br>
                                <a href="products1.php" style="text-decoration:none; color:black; font-size:20px;"><button style="background-color:transparent; outline:none; border:0px;padding:10px; border-bottom:1px solid black;">Physics</button></a><br>
                                <a href="products2.php" style="text-decoration:none; color:black; font-size:20px;"><button style="background-color:transparent; outline:none; border:0px;padding:10px; border-bottom:1px solid black;">Chemistry</button></a><br>
                                <a href="products3.php" style="text-decoration:none; color:black; font-size:20px;"><button style="background-color:transparent; outline:none; border:0px;padding:10px; border-bottom:1px solid black;">Maths</button></a></center>
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header" style="height: 70px">
                            <h2 class="modal-title">Conatct Us</h2>
    ...
    <div id="page" style="margin-top: 0px;">
        ...
        <div class="conatiner" style="margin-top:20px; margin-left:10px; margin-right:10px;">
            <div class="row">
                    ...
                    <div class="thumbnail">
                        ...
                        <div class="caption" id="phy">
                            <center>
                                ...
                                <a href="products.php?id=<?php echo $row['id']; ?>&name=<?php echo $row['name']; ?>&price=<?php echo $row['price']; ?>"><button class="fom-control btn btn-primary">Add to Cart</button></a>
                            </center>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3" id="chem">
                    <div class="thumbnail">
                        <img src="<?php echo $row['image']; ?>" style="width:300px; height:200px;">
                        <div class="caption">
                            <center>
                ...
                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3" id="mth">
                    <div class="thumbnail">
                        <img src="<?php echo $row['image']; ?>" style="width:300px; height:200px;">
                        <div class="caption">
                            <center>
